...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1">
                    <Columns>
                        ...
                        <asp:BoundField DataField="LastName" HeaderText="Last_Name" SortExpression="Last_Name" />
                        <asp:BoundField DataField="Username" HeaderText="User_Name" SortExpression="User_Name" />
                ...
                <asp:SqlDataSource 
                    ...
                    InsertCommand="INSERT INTO [Users] ([Id], [User_Id], [FirstName], [LastName], [Username], [Email], [Password], [Phone_Number]) 
                                   VALUES (@Id, @User_Id, @FirstName, @LastName, @Username, @Email, @Password, @Phone_Number)" 
                    SelectCommand="SELECT [Id], [User_Id], [FirstName], [LastName], [Username], [Email], [Password], [Phone_Number] FROM [Users]" 
                    UpdateCommand="UPDATE [Users] 
                                   SET [User_Id] = @User_Id, [FirstName] = @FirstName, [LastName] = @LastName, [Username] = @Username, 
    ...
    <InsertParameters>
        ...
        <asp:ControlParameter ControlID="txtSurname" Name="LastName" Type="String" />
